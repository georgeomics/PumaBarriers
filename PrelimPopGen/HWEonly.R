...
# Note: You may need to remove any ".1" in column names and remove quotes around zeros to be consistent with original dataset. Can do this with the following code: 
