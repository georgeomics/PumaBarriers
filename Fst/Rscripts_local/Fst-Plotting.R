...
# GRAB DATA
Fstvan_roads <- read.csv("Fst/Rscripts_local/Routput/DATA-Fst-TraditionalWC84-roads.csv", header=TRUE)
Fstvan_rivers <- read.csv("Fst/Rscripts_local/Routput/DATA-Fst-TraditionalWC84-rivers.csv", header=TRUE)
Fstvan_ecoreg <- read.csv("Fst/Rscripts_local/Routput/DATA-Fst-TraditionalWC84-US_L3NAME_num.csv", header=TRUE)
