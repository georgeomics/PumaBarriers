...
# GENERATE TRADITIONAL FST (Weir-Cockerham)
# Note: Similar to permutation code minus a few steps (e.g. not iterating 1000+ times)
...
# CSV OF FST DATA
write.csv(results, "Fst/Rscripts_local/Routput/DATA-Fst-TraditionalWC84-US_L3NAME_num.csv")
...
# CSV OF FST DATA
write.csv(results, "Fst/Rscripts_local/Routput/DATA-Fst-TraditionalWC84-rivers.csv")
...
# CSV OF FST DATA
write.csv(results, "Fst/Rscripts_local/Routput/DATA-Fst-TraditionalWC84-roads.csv")
