...
write.csv(results, "Fst/Rscripts_local/Routput/DATA-Fst-Permutation-US_L3NAME_num.csv")

# PLOTS
# quartz()
pdf("Fst/Rscripts_local/Routput/DATA-Fst-Permutation-US_L3NAME_num-violin-plot.pdf")
...
# CSV OF PERMUTATION DATA
write.csv(results, "Fst/Rscripts_local/Routput/DATA-Fst-Permutation-rivers.csv")

# PLOTS
# quartz()
pdf("Fst/Rscripts_local/Routput/DATA-Fst-Permutation-rivers-violin-plot.pdf")
ggplot(data=results, aes(paircombo, Fst, group=paircombo)) + 
  geom_violin()
dev.off()
...
# CSV OF PERMUTATION DATA
write.csv(results, "Fst/Rscripts_local/Routput/DATA-Fst-Permutation-roads.csv")

# PLOTS
# quartz()
pdf("Fst/Rscripts_local/Routput/DATA-Fst-Permutation-roads-violin-plot.pdf")
ggplot(data=results, aes(paircombo, Fst, group=paircombo)) + 
  geom_violin()
dev.off()
